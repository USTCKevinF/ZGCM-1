...
ACCOUNT=<account>
MLM_PATH="${MLM_PATH:?set MLM_PATH to the Megatron-LM checkout}"
GPT_CKPT="${GPT_CKPT:?set GPT_CKPT to the checkpoint directory}"
VOCAB_MERGE_FILE_PATH="${VOCAB_MERGE_FILE_PATH:?set VOCAB_MERGE_FILE_PATH to the tokenizer directory}"
