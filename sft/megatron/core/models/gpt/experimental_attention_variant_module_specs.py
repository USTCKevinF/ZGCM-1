...
def get_dsa_module_spec_for_backend(
    ...
    assert config.qk_l2_norm is False, "qk_l2_norm is not supported with DSAttention."
    ...
    if config.multi_latent_attention:
        ...
        assert linear_qkv is not None, "DSAttention requires a qkv projection implementation."
